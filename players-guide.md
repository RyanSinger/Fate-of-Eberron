---
layout: guide
title: "Fate of Eberron: Player's Guide"
...
![A dragonmarked heir displaying her mark]({{ '/images/dragonmarked-heir.png' | relative_url }})
...
*Basic Permission*: You can track anyone or anything and sense the presence of dragonshards.

**The Hunt**: Because of my Mark of Finding, I get +2 to Investigate when tracking a specific creature or person.

**Dragonshard Sense**: Because of my Mark of Finding, I can sense dragonshards within one zone. No roll required, but the GM determines what you learn.

### Mark of Handling (House Vadalis)

*Basic Permission*: You have an innate rapport with animals and can calm hostile beasts.

**Animal Empathy**: Because of my Mark of Handling, I can use Rapport with animals as if they were people.

**Magebred Companion**: Because of my Mark of Handling, I have a magebred animal companion. It's a Fair (+2) NPC with one Good (+3) skill relevant to its nature.

### Mark of Healing (House Jorasco)

*Basic Permission*: You can stabilize the dying and speed recovery.

**Healing Touch**: Because of my Mark of Healing, once per scene I can reduce another character's consequence by one step (severe → moderate, moderate → mild, mild → cleared).

**Diagnostic Insight**: Because of my Mark of Healing, I get +2 to Empathy when determining someone's physical or mental condition.
...
*Basic Permission*: You have an intuitive understanding of how things are made and can repair objects.

**Jury-Rig**: Because of my Mark of Making, I can use Crafts to create a temporary repair or device that lasts one scene, even without proper tools or materials.

**Maker's Eye**: Because of my Mark of Making, I get +2 to Investigate when examining constructed objects to understand how they were made or what went wrong.

### Mark of Passage (House Orien)

*Basic Permission*: You can move with supernatural ease and open sealed passages.

**Swift Movement**: Because of my Mark of Passage, I can move two zones as a free action once per scene instead of one.

**Open the Way**: Because of my Mark of Passage, I can use Will to overcome magical barriers and locks that would normally require special keys or rituals.

### Mark of Scribing (House Sivis)

*Basic Permission*: You can comprehend any written language and send short messages over distance.

**Linguist**: Because of my Mark of Scribing, I can read any written language, even ancient or obscure ones.

**Sending**: Because of my Mark of Scribing, once per scene I can send a short message (25 words) to anyone I've met, regardless of distance.

### Mark of Sentinel (House Deneith)

*Basic Permission*: You can sense threats to those you protect.

**Bodyguard**: Because of my Mark of Sentinel, when an ally in my zone would take stress, I may take that stress instead.

**Danger Sense**: Because of my Mark of Sentinel, I get +2 to defend against ambushes and surprise attacks.

### Mark of Shadow (Houses Phiarlan and Thuranni)

*Basic Permission*: You can manipulate light and shadow and create minor illusions.

**Cloak of Shadows**: Because of my Mark of Shadow, I get +2 to Stealth when in dim light or darkness.

**Minor Illusion**: Because of my Mark of Shadow, I can create small, silent visual illusions without rolling. They don't fool close inspection but work for misdirection.

### Mark of Storm (House Lyrandar)

*Basic Permission*: You can sense and subtly influence weather.
...
*Basic Permission*: You can sense wards and traps and create minor protective barriers.

**Trapfinder**: Because of my Mark of Warding, I get +2 to Notice when detecting traps and wards.

**Secure the Area**: Because of my Mark of Warding, I can use Lore to create a magical ward advantage that provides +2 to defend against intrusion in one zone. The ward lasts until the scene ends.
...
>
> With three aspects, the ward falls. But something is now watching...
...
| **Rapport** | Making friends, building trust |
| **Resources** | Wealth, material access |
| **Shoot** | Ranged combat |
| **Stealth** | Hiding, sneaking |
| **Will** | Mental fortitude, resisting stress |
